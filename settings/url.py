...
GIFT_CARD_SEND_CURRENT_CARD_URL = BASE_URL + "v2/ds_order/{ds_order_id}/update_gift_card_usage/"
GIFT_CARD_GET_NEXT_CARD_URL = BASE_URL + "v2/ds_order/{ds_order_id}/next_gift_card/"
