// Enable proxy
if (
  window.location.href.indexOf("admin.stlpro.com/products/getdsorders/") > -1
) {
  isGetOrders = true;
  ...
  ready(function () {
    ...
    if (isEmpty(asinTitl) == true) {
      ...
      asinTitl[0].innerHTML = contains("tr", "Asin Title")[0].innerHTML.replace(
        /td/g,
        "th"
      );

      contains("tr", "Asin Title")[0].outerHTML =
        "<tr><td><td><td><td><td><td><td><a href=javascript:null; target=_blank>Open All Items</a><td><td><td><td><td><td><td><td><td><td><td><td><td>" +
        contains("tr", "Asin Title")[0].outerHTML;
      ...
      document.getElementById("site-name").outerHTML =
        '<span style="float:left">' +
        document.getElementById("site-name").outerHTML +
        "</span>";

      document.getElementById("branding").outerHTML =
        document.getElementById("branding").outerHTML +
        '<span style="float:right;font-size:15px"><a id="chrome-ext" target="_blank" style="text-decoration:none" href="https://chrome.google.com/webstore/detail/stl-pro-dropship-helper/lfojkfpamgfacngbdcbdagbpdohmjace">Dropship Helper Version: ' +
      ...
      orderStatusColumn = orderStatusColumn.splice(
        4,
        orderStatusColumn.length - 1
      );
      extraItem = extraItemCol[extraItemCol.length - 1].innerText;

      if (supplierColumn[0].innerText.indexOf("Walmart") > -1) {
        document.querySelectorAll("td")[5].innerHTML =
          '<a href="https://www.walmart.com/account/login?returnUrl=%2Fcart"; target=_blank>WALMART PREPROCESSED: Sign-in & Checkout</a>';
        document.querySelectorAll("td")[6].innerHTML =
          '<a href="https://www.walmart.com/account/signup?returnUrl=%2Flists%2Fcreate-events-registry%3Fr%3Dyes"; target=_blank>WALMART: Open Signup & Registry</a>';
      }

      function clickAllItems() {
        if (
          document.querySelectorAll("tbody")[1].querySelectorAll("tr").length ==
            1 &&
          extraItem !== ""
        ) {
          ...
          (document.querySelectorAll("tbody")[1].querySelectorAll("tr").length >
            1 &&
            extraItem == "") ||
          (document.querySelectorAll("tbody")[1].querySelectorAll("tr")
            .length == 1 &&
            extraItem == "")
        ) {
          for (var i = 0; i < itemNumCol.length; i++) {
          ...
          document.querySelectorAll("tbody")[1].querySelectorAll("tr").length >
            1 &&
          extraItem !== "" &&
          supplierColumn[0].innerText.indexOf("Home Depot") > -1
        ) {
          for (var i = 0; i < itemNumCol.length; i++) {
            window.open(itemNumCol[i].querySelector("a").href);
          }
          window.open(extraItemCol[0].querySelector("a").href);
          window.focus();
        }
      }

      contains("a", "Open All Items")[0].addEventListener(
        "click",
        clickAllItems
      );
      console.log("supplier Column", supplierColumn);
      for (var i = 0; i < supplierColumn.length; i++) {
        ...
        if (supplierColumn[i].innerText.indexOf("BestBuy") > -1) {
          ...
          supplierColumn[i] = "H";
        } else if (supplierColumn[i].innerText.indexOf("Bass Pro") > -1) {
          supplierColumn[i] = "G";
        }
      }
      ...
      function checkAutoDS(callback) {
        if (document.querySelector('[id="autods_alert"]') !== null) {
          ...
          document.querySelector('[class="info"]').outerHTML =
            document.querySelector('[class="info"]').outerHTML +
            '<li id="dsh_alert" class="info"><b>Dropship Helper: Confirmed AutoDS captured needed info. Proxy has been enabled.</b></li>';
          callback && callback();
        } else {
      ...
      if (
        document.getElementsByClassName("info")[0].innerText ==
          "All Order Items are updated successfully" ||
        document.getElementsByClassName("info")[0].innerText ==
...
selectValue = (selector, value) => {
  document.querySelector(selector).select();
  document.execCommand("select", false, value);
};
...
window.callLoadDSAddress = function (flds) {
  ...
  if (fld[0] == "U") {
    ...
    window.loadDSAddress = loadDSAddressBasspro;
  }
...
window.callLoadDSNumber = function (dsOrderID) {
  if (
    window.location.href.indexOf("bestbuy.com") > -1 &&
    document.querySelector('[id="dsOrderID"]') === null
  ) {
    var ordnum = dsOrderID;
    var elemTag = document.createElement("span");
    elemTag.innerHTML = ordnum;
    elemTag.setAttribute("id", "dsOrderID");
    elemTag.setAttribute("hidden", "true");
    document.head.appendChild(elemTag);
  }
};
...
window.callLoadEmail = function (email, supplier) {
  ...
  if (supplier === "U") {
    ...
    if (
      window.location.href.indexOf("create-events-registry") > -1 &&
      window.location.href.indexOf("account/signup") > -1
    ) {
      fillText('[id="email-su"]', email);
      fillText('[id="password-su"]', "Forte1long!");
      document.querySelector('[id="su-newsletter"]').click();
    } else if (window.location.href.indexOf("/account/login") > -1) {
      fillText('[id="email"]', email);
      fillText('[id="password"]', "Forte1long!");
    } else {
      try {
    ...
    if (document.querySelector('[id="guestLoginValue"]') !== null) {
      ...
      document.execCommand("insertText", false, email);
    } else if (document.querySelector('[name="email"]') !== null) {
      document.querySelector('[name="email"]').select();
      document.execCommand("insertText", false, email);
    } else {
    ...
    if (document.querySelector('[id*="recipientsEmailAddress"]') !== null) {
      var giftEmailFields = document.querySelectorAll(
        '[id*="recipientsEmailAddress"]'
      );
      for (var i = 0; i < giftEmailFields.length; i++) {
        giftEmailFields[i].select();
        document.execCommand("insertText", false, email);
      }
    }
    ...
    var selector = '[name="email1"]';
    fillText(selector, email);
  }
};

window.callLoadCardInfo = async function (card_info, supplier) {
  var $ = function (sel) {
    return document.querySelector(sel);
  };
  if (supplier === "P") {
    ...
    document.querySelector('[name="cardNumber"]').selected = true;
    fillText('[name="cardNumber"]', ccArray[7]);
    document
    ...
    document.querySelector('[name="cvvField"]').selected = true;
    fillText('[name="cvvField"]', ccArray[8]);
    document
      .querySelector('[name="cvvField"]')
      .dispatchEvent(new Event("input", { bubbles: true }));
    document
      .querySelector('[name="cvvField"]')
      .dispatchEvent(new Event("change", { bubbles: true }));
    ...
    document
      .querySelector('[name="cardExpiryMonth"]')
      .querySelector('option[value^="' + ccExp[0] + '"]').selected = true;
    document
      .querySelector('[name="cardExpiryMonth"]')
      .dispatchEvent(new Event("input", { bubbles: true }));
    document
    ...
    document
      .querySelector('[name="cardExpiryYear"]')
      .querySelector('option[value^="' + ccExp[1] + '"]').selected = true;
    document
      .querySelector('[name="cardExpiryYear"]')
      .dispatchEvent(new Event("input", { bubbles: true }));
    document
    ...
    if (document.querySelector('input[id="emailSubscription"]') !== null) {
      if (
        document.querySelector('input[id="emailSubscription"]').checked == true
      ) {
        document.querySelector('input[id="emailSubscription"]').click();
      }
    }
  } else if (supplier == "W") {
    console.log(card_info);
    ...
    fillText('[name="addressLineOne"]', "1380 South Kinghsighway Blvd");
    fillText('[name="addressLineTwo"]', "");

    fillText('[name="creditCard"]', ccArray[7]);
    document
      .querySelector('[data-automation-id="expiryMonth-cc"]')
      .querySelector('option[value^="' + ccExp[0] + '"]').selected = true;
    document
      .querySelector('[data-automation-id="expiryMonth-cc"]')
      .dispatchEvent(new Event("input", { bubbles: true }));
    ...
    document
      .querySelector('[data-automation-id="expiryYear-cc"]')
      .querySelector('option[value^="' + ccExp[1] + '"]').selected = true;
    document
      .querySelector('[data-automation-id="expiryYear-cc"]')
      .dispatchEvent(new Event("input", { bubbles: true }));
    ...
    fillText('[name="cvv"]', ccArray[8]);

    fillText('[name="city"]', "SAINT LOUIS");
    document
      .querySelector('[data-automation-id="state-cc"]')
      .querySelector('option[value^="' + "MO" + '"]').selected = true;
    document
      .querySelector('[data-automation-id="state-cc"]')
      .dispatchEvent(new Event("input", { bubbles: true }));
    document
    ...
    fillText('[name="postalCode"]', "63110");
  } else if (supplier == "B") {
    console.log(card_info);
    creditCardInfo = card_info.split("|");
    console.log(creditCardInfo);
    const creditCardNum = creditCardInfo[7];
    const securityCode = creditCardInfo[8];
    const expireMonth = creditCardInfo[9].split("/")[0];
    const expireYear = creditCardInfo[9].split("/")[1];
    fillText('[id="optimized-cc-card-number"]', creditCardNum);
    await sleep(500);
    fillText('[id="credit-card-cvv"]', securityCode);
    ///---- Select month ----///
    el = document.querySelector('[name="expiration-month"]');
    el.querySelector(`option[value="${expireMonth}"]`).selected = true;
    el.dispatchEvent(new Event("input", { bubbles: true }));
    el.dispatchEvent(new Event("change", { bubbles: true }));
    el.dispatchEvent(new Event("blur"));
    ///---- Select year ----///
    el = document.querySelector('[name="expiration-year"]');
    el.querySelector(`option[value="${expireYear}"]`).selected = true;
    el.dispatchEvent(new Event("input", { bubbles: true }));
    el.dispatchEvent(new Event("change", { bubbles: true }));
    el.dispatchEvent(new Event("blur"));
  }
...
window.callLoadGiftCardInfo = function (gift_card_num, supplier) {
  ...
  if (supplier == "B") {
    ...
    if (
      document.querySelector('[data-track="gift-promo-code-link"]') !== null
    ) {
      function bbyApply() {
        document
          .querySelector(
            '[class="gift-promo-cards__apply-btn btn btn-outline"]'
          )
          .click();
      }
      ...
      setTimeout(function () {
        bbyCode = document.getElementById("payment-promotion-code");
        bbyPIN = document.getElementById("payment-giftCard-pin");

        fillText('[id="payment-promotion-code"]', gcArray[0]);
      ...
      if (document.querySelector('[class="gift-promo-cards"]') !== null) {
        if (document.querySelector('[id="promotionCode"]') !== null) {
          ...
          document.querySelector('[id="payment.promotionCode"]') !== null
        ) {
          bbyCode = document.getElementById("payment.promotionCode");
          fillText('[id="payment.promotionCode"]', gcArray[0]);
        } else {
      ...
      setTimeout(function () {
        if (
          ...
          document
            .querySelector('[class="gift-cards__apply-btn btn btn-outline"]')
            .click();
        }
      }, 100);
  ...
  if (supplier == "H") {
    ...
    setTimeout(function () {
      document.querySelector('[class="applyGiftCard"]').click();
    }, 200);
  }
  ...
  if (supplier == "W") {
    ...
    fillText('[data-automation-id="enter-gift-card-number"]', gcArray[0]);
    fillText('[data-automation-id="enter-gift-card-pin"]', gcArray[1]);

    setTimeout(function () {
      document
        .querySelector('[data-automation-id="submit-apply-gift-card"]')
        .click();
    }, 200);
  }
  ...
  if (supplier == "P") {
    ...
    if (document.querySelectorAll('[name="giftCardNumber"]').length == 0) {
      document
        .querySelector('[data-automation-id="applyGiftcardLink"]')
        .click();
      setTimeout(function () {
        fillHDGC();
      }, 789);
    ...
    /*
		document.querySelector('[name="cardNumber"]').selected = true;
        fillText('[name="cardNumber"]', ccArray[7]);
		document.querySelector('[name="cardNumber"]').dispatchEvent(new Event('input', {bubbles: true}));
		document.querySelector('[name="cardNumber"]').dispatchEvent(new Event('change', {bubbles: true}));
		document.querySelector('[name="cardNumber"]').dispatchEvent(new Event('blur'));
*/

    function fillHDGC() {
      if (document.getElementById("giftCardNumber").value !== "") {
        document.querySelector('[name="giftCardNumber"]').selected = true;
        fillText('[name="giftCardNumber"]', "");
        fillText('[name="giftCardNumber"]', gcArray[0]);
        document
          .querySelector('[name="giftCardNumber"]')
          .dispatchEvent(new Event("input", { bubbles: true }));
        document
          .querySelector('[name="giftCardNumber"]')
          .dispatchEvent(new Event("change", { bubbles: true }));
        ...
        document.querySelector('[name="PINNumber"]').selected = true;
        fillText('[name="PINNumber"]', "");
        fillText('[name="PINNumber"]', gcArray[1]);
        document
          .querySelector('[name="PINNumber"]')
          .dispatchEvent(new Event("input", { bubbles: true }));
        document
          .querySelector('[name="PINNumber"]')
          .dispatchEvent(new Event("change", { bubbles: true }));
  ...
  if (supplier == "K") {
    ...
    setTimeout(function () {
      contains('[class="shc-btn"]', "Apply")[0].click();
    }, 200);
  }

  if (supplier === "G") {
    gcArray = gift_card_num.split(",");
    fillText('[id="giftCardNo"]', gcArray[0]);
    fillText('[id="pinNumber"]', gcArray[1]);

    setTimeout(function () {
      document
        .querySelector('[id="BPS_GC_Pin_Code"]')
        .querySelector("a")
        .click();
    }, 200);
  }
...
window.getSupplierSiteTotal = function (supplier) {
  if (supplier == "T") {
    order_total = contains(
      'p[class="h-text-lg h-text-bold"]',
      "Total"
    )[0].parentElement.lastChild.innerText.replace(/[^0-9.]/g, "");
  ...
  if (supplier == "K") {
    order_total = document
      .querySelector('[ng-bind-html="ordersummary.totalDue | price:true"]')
  ...
  if (supplier == "P") {
    order_total = document
      .querySelectorAll('[data-automation-id="totalLabel"]')[0]
      .parentElement.querySelector('[class="price__format"]').parentElement;
    order_total =
      textNodesUnder(order_total)[2].textContent +
      "." +
      textNodesUnder(order_total)[3].textContent;
    order_total = +order_total;
  ...
  if (supplier == "B") {
    order_summary = document.querySelectorAll(
      '[class="order-summary-card__total-line"]'
    );
    ...
    order_total = +document
      .querySelector('[class="order-summary__total"]')
      .innerText.replace(/[^0-9.]/g, "");
  ...
  if (supplier == "W") {
    order_total = document
      .querySelector('[data-automation-id="pos-grand-total-amount"]')
      .innerText.replace("$", "");
  ...
  if (supplier === "G") {
    order_total = document
      .querySelector('[id="BPS_OPC_ORDER_GRAND_TOTAL"]')
      .innerText.replace("$", "");
...
window.getGiftCardInfo = function (supplier) {
  if (supplier == "W") {
    ...
    function wmGC() {
      ...
      function wm_DOMCheck() {
        wm_gc_used = document.querySelectorAll(
          '[data-automation-id*="gift-card-tile-index-"]'
        );
        if (isEmpty(wm_gc_used) == true) {
          // If element doesn't exist, try again
          setTimeout(wm_DOMCheck, 100);
        } else {
          if (
            document.getElementById("totalGCs") !== null &&
            wm_gc_used.length == +document.getElementById("totalGCs").innerText
          ) {
            ...
            for (var i = 0; i < totalGCs; i++) {
              if (
                document.querySelector('[id="GiftcardEmptyModal"]') !== null &&
                i == totalGCs - 1
              ) {
                /*
								console.log('Empty gift card found');
								gc_applied_info[i] = wm_gc_used[i].querySelector('[class="alternate-payment__actions"]').innerText.search('\n');
								gc_applied_info[i] = wm_gc_used[i].querySelector('[class="alternate-payment__actions"]').innerText.substr(1, gc_applied_info[i] - 1);
								gc_last_four = wm_gc_used[i].querySelector('[class="alternate-payment__details"]').innerText.replace(/[^0-9.]/g, "");
								...
								if (i == totalGCs) {
									totalGCs = totalGCs - 1;
									gc_total_remaining = wm_gc_used[i].querySelector('[class="alternate-payment__actions"]').querySelector('[class="alternate-payment__subprice"]').innerText.search('left');
									gc_total_remaining = wm_gc_used[i].querySelector('[class="alternate-payment__actions"]').querySelector('[class="alternate-payment__subprice"]').innerText.substr(2, gc_total_remaining - 3);
                ...
                gc_applied_info[i] = wm_gc_used[i]
                  .querySelector('[class="price gc-amount-paid-price"]')
                  .children[0].innerText.replace("$", "");
                gc_last_four = wm_gc_used[i]
                  .querySelector('[data-automation-id*="gift-card-last-four"]')
                  .innerText.trim()
                  .split("ending in ")[1];
                gc_applied_info[i] = gc_applied_info[i] + "||" + gc_last_four;
                gc_applied_info[i] = gc_applied_info[i].split("||");
                ...
                if (i == totalGCs) {
                  gc_total_remaining = wm_gc_used[i]
                    .querySelector(
                      '[data-automation-id*="gift-card-tile-remaining-msg"]'
                    )
                    .innerText.split("$")[1];
                  gc_applied_info[i][2] = gc_total_remaining;
                } else {
    ...
    function targGC() {
      ...
      function targ_DOMCheck() {
        ...
        if (isEmpty(target_gc_used) == true) {
          ...
          if (
            document.getElementById("totalGCs") !== null &&
            target_gc_used.length ==
              +document.getElementById("totalGCs").innerText
          ) {
            // Button has been clicked again, wait for additional element and try again
            setTimeout(targ_DOMCheck, 100);
            return;
            ...
            for (var i = 0; i < totalGCs; i++) {
              gc_applied_info[i] =
                target_gc_used[i].innerText.search("applied");
              gc_applied_info[i] = target_gc_used[i].innerText.substr(
                1,
                gc_applied_info[i] - 2
              );
              gc_last_four = target_gc_used[i].innerText.search("from");
              gc_last_four = target_gc_used[i].innerText
                .substr(gc_last_four + 5, 8)
                .replace(/\*/g, "");
              gc_applied_info[i] = gc_applied_info[i] + "||" + gc_last_four;
              gc_applied_info[i] = gc_applied_info[i].split("||");
            }
            ...
            //						if (document.querySelectorAll('[class="h-margin-l-tiny h-padding-r-tight h-text-bs h-display-inline-block h-vertical-align-middle"]')[2].innerText == "3 of 6 | Order pickup info") {
  ...
  if (supplier == "P") {
    function hdGC() {
      ...
      function hd_DOMCheck() {
        hd_gc_used = document.querySelectorAll(
          '[ng-repeat="giftCard in user.giftCards"]'
        );
        if (isEmpty(hd_gc_used) == true) {
          ...
          if (
            document.getElementById("totalGCs") !== null &&
            hd_gc_used.length == +document.getElementById("totalGCs").innerText
          ) {
            // Button has been clicked again, wait for additional element and try again
            setTimeout(hd_DOMCheck, 100);
            return;
            ...
            hdTotal = document
              .querySelectorAll('[ng-if="order.orderAmount"]')[1]
              .querySelector('[class="price__format"]').parentElement;
            hdTotal =
              textNodesUnder(hdTotal)[1].textContent +
              "." +
              textNodesUnder(hdTotal)[2].textContent;
            hdTotal = +hdTotal;
            ...
            if (isEmpty(prevHdRemaining) == true) {
              if (
                isEmpty(
                  contains(
                    '[ng-if="!paymentCard.cardNumber && !paymentCard.profileOrderId"][class="alert-inline__message ng-scope"]',
                    "Please provide an additional"
                  )
                ) == false
              ) {
                hdRemaining = +contains(
                  '[ng-if="!paymentCard.cardNumber && !paymentCard.profileOrderId"][class="alert-inline__message ng-scope"]',
                  "Please provide an additional"
                )[0].children[0].innerText.replace("$", "");
                hdGcUsed = +hdTotal - +hdRemaining;
                prevHdRemaining[0] = hdRemaining;
                gc_applied_info[0] =
                  hdGcUsed +
                  "||" +
                  hd_gc_used[0].innerText
                    .replace("Remove", "")
                    .replace("****", "")
                    .replace("PIN: ", ",")
                    .replace("	", "")
              ...
              hdRemaining !== prevHdRemaining[totalGCs - 1] &&
              isEmpty(
              ...
              hdGcUsed =
                Math.round(
                  (prevHdRemaining[totalGCs - 2] - hdRemaining) * 100
                ) / 100;
              prevHdRemaining[totalGCs - 1] = hdRemaining;
              gc_applied_info[totalGCs - 1] =
                hdGcUsed +
                "||" +
                hd_gc_used[totalGCs - 1].innerText
                  .replace("Remove", "")
                  .replace("****", "")
                  .replace("PIN: ", ",")
                  .replace("	", "")
                  .trim();
              gc_applied_info[totalGCs - 1] =
                gc_applied_info[totalGCs - 1].split("||");
              // Grab info for last gift card.
            } else if (
              isEmpty(
                document.querySelectorAll(
                  '[ng-show="!paymentCard.giftCardRemoved"][class="alert-inline__message"]'
                )
              ) == false
            ) {
            ...
            // Pass info to popup.js
            console.log("gc applied info ", gc_applied_info);
            chrome.runtime.sendMessage({
              infoGrabbed: true,
              gc_applied_info: gc_applied_info,
              gc_length: totalGCs,
  ...
  if (supplier === "B") {
    ...
    function bbyGC() {
      ...
      function bby_DOMCheck() {
        bby_gc_used = document.querySelectorAll(
          '[class="alternate-payment clearfix"]'
        );
        if (isEmpty(bby_gc_used) == true) {
          ...
          if (
            document.getElementById("totalGCs") !== null &&
            bby_gc_used.length == +document.getElementById("totalGCs").innerText
          ) {
            // Button has been clicked again, wait for additional element and try again
            setTimeout(bby_DOMCheck, 100);
            return;
            ...
            for (var i = 0; i < totalGCs; i++) {
              if (
                ...
                console.log("Empty gift card found");
                gc_applied_info[i] = bby_gc_used[i]
                  .querySelector('[class="alternate-payment__actions"]')
                  .innerText.search("\n");
                gc_applied_info[i] = bby_gc_used[i]
                  .querySelector('[class="alternate-payment__actions"]')
                  .innerText.substr(1, gc_applied_info[i] - 1);
                gc_last_four = bby_gc_used[i]
                  .querySelector('[class="alternate-payment__details"]')
                  .innerText.replace(/[^0-9.]/g, "");
                gc_last_four = gc_last_four.substr(gc_last_four.length - 4, 4);
                gc_applied_info[i] = gc_applied_info[i] + "||" + gc_last_four;
                gc_applied_info[i] = gc_applied_info[i].split("||");
                ...
                if (i == totalGCs) {
                  totalGCs = totalGCs - 1;
                  gc_total_remaining = bby_gc_used[i]
                    .querySelector('[class="alternate-payment__actions"]')
                    .querySelector('[class="alternate-payment__subprice"]')
                    .innerText.search("left");
                  gc_total_remaining = bby_gc_used[i]
                    .querySelector('[class="alternate-payment__actions"]')
                    .querySelector('[class="alternate-payment__subprice"]')
                    .innerText.substr(2, gc_total_remaining - 3);
                  gc_applied_info[i][2] = gc_total_remaining;
                } else {
                  totalGCs = totalGCs - 1;
                  gc_applied_info[i][2] = "0.00";
                ...
                gc_last_four = bby_gc_used[i]
                  .querySelector('[class="alternate-payment__details"]')
                  .innerText.substr(gc_last_four + 1, 8)
                  .replace(/[^0-9.]/g, "");
                gc_applied_info[i] = gc_applied_info[i] + "||" + gc_last_four;
                gc_applied_info[i] = gc_applied_info[i].split("||");
        ...
        if (isEmpty(kohls_gc_used) == true) {
          ...
          if (
            ...
            for (var i = 0; i < totalGCs; i++) {
              if (
                document
                  .querySelector('[id="amnt_applied_confirm"]')
                  .children[i].children[0].innerText.trim()
                  .indexOf("Gift Cardx") > -1
              ) {
                gc_applied_info[i] = document
                  .querySelector('[id="amnt_applied_confirm"]')
                  .children[i].children[1].innerText.trim()
                  .replace("$", "");
              }
              gc_last_four = document
                .querySelector('[id="amnt_applied_confirm"]')
                .children[i].children[0].innerText.trim()
                .split("Gift Cardx")[1];
              gc_applied_info[i] = gc_applied_info[i] + "||" + gc_last_four;
            ...
            if (
              document.querySelectorAll(
                '[class="h-padding-a-tight h-margin-l-tiny h-text-bs h-display-inline-block h-text-black"]'
              )[2].innerText == "3 of 6 | Order pickup info"
            ) {
              //							setTimeout(ccTrick1, 1000);
            }
          }
  ...
  if (supplier === "G") {
    function bassproDomCheck() {
      var basspro_gc_used = document.querySelectorAll(
        '[id="bps_opc_gc_applied_info"]'
      );
      if (isEmpty(basspro_gc_used)) {
        setTimeout(() => {
          bassproDomCheck;
        }, 100);
      } else {
        var gift_card_num = document.querySelector(
          '[id="picked_gift_cards"]'
        ).innerText;
        gift_card_num = gift_card_num.replace("\n", "").split(",")[0];
        var gc_applied_amount = document
          .querySelector('[id="bps_opc_gc_applied_info"]')
          .innerText.match(/\$[0-9]{1,}\.[0-9]{1,}/g)[0]
          .replace("$", "");
        var gc_applied_info = [];
        gc_applied_info.push(gift_card_num);
        gc_applied_info.push(gc_applied_amount);

        var gc_total = document
          .querySelector('[id="BPS_OPC_ORDER_GRAND_TOTAL"]')
          .innerText.replace("$", "");
        var totalGCs = document.querySelectorAll(
          '[id="bps_opc_gc_applied_info"]'
        ).length;
  ...
  if (supplier === "B") {
    if (window.location.href.indexOf("/fulfillment") > -1) {
      if (document.querySelector('[id*="recipientsEmailAddress-"]') !== null) {
        for (var i = 0; i < 2; i++) {
          document
            .querySelectorAll('[id*="recipientsEmailAddress-"]')
            [i].select();
          document.execCommand("insertText", false, username);
        }
      } else {
        fillText('[id="user.emailAddress"]', username);
      }
    }
    // fillText('[type="password"]', password);
  }

  if (supplier === "P") {
    if (window.location.href.indexOf("auth/view/checkout/signin") > -1) {
      fillText("input[id=email]", username);
      fillText("input[id=password-input-field]", password);
    }
  }
};
...
// TRU
window.loadDSAddressTRU = function (
  fname,
  lname,
  add1,
  add2,
...
window.loadDSAddressKMart = function (
  fname,
  lname,
  add1,
  add2,
  ...
  for (var i = 0; i < selectors.length; i++) {
    var el = document.querySelector(
      "div.address-layer input[name=" + selectors[i] + "]"
    );
...
// Target
window.loadDSAddressTarget = function (
  fname,
  lname,
  add1,
  add2,
  ...
  if (
    window.location.href.indexOf("co-delivery") > -1 &&
    document.querySelector('[data-test="addressLine2-text"]').placeholder ===
      undefined
  ) {
    if (add2 !== "") {
      ...
      document.querySelector('[data-test="addressLine2-text"]').click();
    }
  }

  if (window.location.href.indexOf("co-login") > -1) {
    if (document.querySelector("h1") !== null) {
      if (document.querySelector("h1").innerText.indexOf("Create your") > -1) {
        var pw = "forte1long";
        ...
        var values = [_v(fname), _v(lname), _v(pw)];
  ...
  if (add2 !== "") {
    ...
    var selectors = ["fullName", "addressLine1", "zipCode", "city", "mobile"];

    var values = [_v(full_name), _v(add1), _v(zip), _v(city), _v(phone)];
  }
...
window.loadDSAddressSamsClub = function (
  fname,
  lname,
  add1,
  add2,
  ...
  document.getElementsByClassName("selected pull-left")[0].innerHTML =
    _v(state);
...
window.loadDSAddressWalMart = function (
  fname,
  lname,
  add1,
  add2,
  ...
  if (
    ...
    if (window.location.href.indexOf("/lists/create-events-registry") > -1) {
      ...
      document
        .querySelector('[id="eventDate"]')
        .dispatchEvent(new Event("focuse"));
      document.querySelector('[id="eventDate"]').value = scheduleDate;
      document
        .querySelector('[id="eventDate"]')
        .dispatchEvent(new Event("input", { bubbles: true }));
    ...
    // just ..Zip.
    var selectors = [
      "COAC2ShpAddrFirstName",
      "COAC2ShpAddrLastName",
      "COAC2ShpAddrAddress1",
      "COAC2ShpAddrAddress2",
      "COAC2ShpAddrCity",
      "COAC2ShpAddrZip",
      "COAC2ShpAddrPhone",
    ];
    ...
    if (
      document.querySelector('[for="marketingEmailPref"]') !== null &&
      document
        .querySelector('[for="marketingEmailPref"]')
...
// Fisher Price
window.loadDSAddressFisherPrice = function (
  fname,
  lname,
  add1,
  add2,
...
// Home Depot
window.loadDSAddressHomeDepot = async function (
  fname,
  lname,
  add1,
  add2,
  ...
  add1 = add1.replace(/[\&\/\#\+\(\)\$\"\~\%\*\?\<\>]/g, "");
  add2 = add2.replace(/[\&\/\#\+\(\)\$\"\~\%\*\?\<\>]/g, "");
  email_element = document.querySelectorAll('[name="email"]')[0];

  if (window.location.href.indexOf("/p/") > -1) {
    fillText('[name="appliance__zip-code"]', zip);
    setTimeout(contains("span", "Check")[0].click(), 500);
  }
  if (window.location.href.indexOf("auth/view/checkout/signin") > -1) {
    fillText('[id="email"]');
  }
  if (window.location.href.indexOf("createaccount/diy") > -1) {
    fillText('[id="password-input-field"]', "forte1long");
    fillText('[id="zipCode"]', zip);
    fillText('[id="phone"]', phone);
  }
  ...
  if (window.location.href.indexOf("mycheckout/checkout") > -1) {
    if (document.querySelector('[data-automation-id="firstName"]') !== null) {
      setTimeout(insertValue, 50, '[data-automation-id="firstName"]', fname);
      setTimeout(insertValue, 70, '[data-automation-id="lastName"]', lname);
      setTimeout(insertValue, 100, '[data-automation-id="phone"]', phone);
      setTimeout(insertValue, 150, '[data-automation-id="zipCodeField"]', zip);
      if (document.querySelector('[data-automation-id="line2"]').value) {
        document.querySelector('[data-automation-id="line2"]').value = "";
      }
      setTimeout(insertValue, 300, '[data-automation-id="line2"]', add2);
      setTimeout(insertValue, 400, '[data-automation-id="line1"]', add1);
      ...
      setTimeout(insertValue, 200, '[data-automation-id="line2"]', add2);
      setTimeout(insertValue, 300, '[data-automation-id="line1"]', add1);
      localStorage.setItem("city", city);
      localStorage.setItem("state", state);
      localStorage.setItem("add1", add1);
      localStorage.setItem("add2", add2);
    ...
    setTimeout(() => {
      if (!document.querySelector('[data-automation-id="line2"]').value) {
        document.querySelector('[data-automation-id="line2"]').value = add2;
      }
    }, 1000);
  }
};
...
// Best Buy
window.loadDSAddressBestBuy = function (
  fname,
  lname,
  add1,
  add2,
  ...
  if (window.location.href.indexOf("fulfillment") > -1) {
    ...
    if (add2 !== "") {
      for (var i = 0; i < selectors.length; i++) {
        var selector = "[id*=" + selectors[i] + "]:not(.hide_elem)";
        var el;
        el = document.querySelector(selector);
        if (i == 0) {
        ...
        if (i == 3) {
          ...
          for (var j = 0; j < optAddyLength; j++) {
            document
              .querySelector('[id*=".street2"]')
              .setAttribute("id", "optAddy" + j);
          }
          for (var j = 0; j < optAddyLength; j++) {
            document
              .querySelector('[id*=".street"]')
              .setAttribute("id", "mainAddy" + j);
          }
          fillText(selector, values[i]);
          document.querySelector("input[id*=mainAddy]").id = document
            .querySelector("input[id*=mainAddy]")
            .id.replace("mainAddy", "addyFilled");
          setTimeout(hideAddySuggest, 700);
        }
        if (i == 4) {
          fillText(selector, values[i]);
          document.querySelector("input[id*=optAddy]").id = document
            .querySelector("input[id*=optAddy]")
            .id.replace("optAddy", "optFilled");
        }
        if (i == 5) {
          fillText(selector, values[i]);
...
// Buy Buy Baby
window.loadDSAddressBuyBuyBaby = function (
  fname,
  lname,
  add1,
  add2,
  ...
  if (
    window.location.href.indexOf("buybuybaby") > -1 &&
    window.location.href.indexOf("checkout/billing") > -1
  ) {
...
// Kohls
window.loadDSAddressKohls = function (
  fname,
  lname,
  add1,
  add2,
...
window.loadDSAddressBasspro = function (
  fname,
  lname,
  add1,
  add2,
  ...
  for (var i = 0; i < selectors.length; i++) {
    ...
    if (i == 4 && document.querySelector('[name="address2"]').value == "..") {
      fillText(selector, "");
    }
    if (i == 6) {
      el.querySelector("option[value=" + values[i] + "]").selected = true;
